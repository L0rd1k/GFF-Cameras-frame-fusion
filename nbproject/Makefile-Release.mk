...
${OBJECTDIR}/BaseImageFusion.o: BaseImageFusion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseImageFusion.o BaseImageFusion.cpp

${OBJECTDIR}/BaseVideoFusion.o: BaseVideoFusion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseVideoFusion.o BaseVideoFusion.cpp

${OBJECTDIR}/GFF.o: GFF.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GFF.o GFF.cpp
